//! # tuple_swizzle
//!
//! `tuple_swizzle` adds swizzle operations( such as (1, 255, 255, 255).bgra(), (1, 2.0_f32).yx(),  or (1, 2, 3, 4).wzyx() ), familiar to anyone who used GLSL, to tuples of up to 4 elements.
